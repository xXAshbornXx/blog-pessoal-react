...
function FormPostagem() {
  ...
  async function buscarPostagemPorId(id: string) {
    try {
      await buscar(`/postagens/${id}`, setPostagem as any, {
  ...
  async function buscarTemaPorId(id: string) {
    try {
      await buscar(`/temas/${id}`, setTema as any, {
        headers: { Authorization: token },
      });
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    } catch (error: any) {
  ...
  async function buscarTemas() {
    try {
      await buscar(`/temas`, setTemas as any, {
        headers: { Authorization: token },
      });
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    } catch (error: any) {
  ...
  async function gerarNovaPostagem(e: FormEvent<HTMLFormElement>) {
    ...
    if (id !== undefined) {
      try {
        await atualizar(`/postagens`, postagem, setPostagem as any, {
          headers: {
            Authorization: token,
          },
        });
      ...
      try {
        await cadastrar(`/postagens`, postagem, setPostagem as any, {
          headers: {
            Authorization: token,
          },
        });
